...
app.get("/room/:meetingRoomId", function (req, res) {
...
app.put("/room/:meetingRoomId", function (req, res) {
    var meetingRoomId = req.params.meetingRoomId;
...
app.delete("/room/:meetingRoomId", function (req, res) {
